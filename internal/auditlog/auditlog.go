...
const (
	...
	ActionAppIdentifierBuildNumberAllocated Action = "app_identifier.build_number_allocated"
	ActionAndroidCredentialsSaved           Action = "android_credentials.saved"
	ActionAndroidCredentialsGenerated       Action = "android_credentials.generated"
	ActionAndroidKeystoreDownloaded         Action = "android_keystore.downloaded"
	ActionGooglePlayServiceAccountSaved     Action = "google_play_service_account.saved"
	ActionGooglePlayServiceAccountDeleted   Action = "google_play_service_account.deleted"
